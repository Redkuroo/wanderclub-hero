...
const Navbar = () => (
  <motion.nav
    ...
    className="flex items-center justify-between border-b px-2 sm:px-4 md:px-8 py-3 md:py-4 bg-white w-full md:gap-4 lg:gap-6"
  >
    {/* Logo */}
    <div className="flex items-center gap-2 md:gap-4 lg:gap-6 min-w-[100px] sm:min-w-[120px] md:min-w-[160px] lg:min-w-[200px]">
      <Image src="/logo.svg" alt="The Wander Club Logo" width={100} height={28} priority className="w-[100px] h-[28px] sm:w-[120px] sm:h-[32px] md:w-[140px] md:h-[32px] lg:w-[160px] lg:h-[32px]" />
    </div>
    {/* Nav Links (hidden on mobile) */}
    <ul className="hidden md:flex gap-4 lg:gap-8 font-semibold text-xs sm:text-base md:text-lg flex-1 justify-center">
    ...
    <div className="flex items-center gap-2 sm:gap-3 md:gap-4 lg:gap-6 min-w-[100px] sm:min-w-[120px] md:min-w-[200px] lg:min-w-[320px] justify-end">
      ...
      {/* Mobile icons */}
      <Image src="/Customer.svg" alt="Customer" width={22} height={22} className="w-[22px] h-[22px] sm:w-[24px] sm:h-[24px] md:w-[28px] md:h-[28px] lg:w-[32px] lg:h-[32px] transition-transform duration-150 hover:scale-110 focus:scale-110 cursor-pointer" />
      <Image src="/Shopping Cart.svg" alt="Cart" width={22} height={22} className="w-[22px] h-[22px] sm:w-[24px] sm:h-[24px] md:w-[28px] md:h-[28px] lg:w-[32px] lg:h-[32px] transition-transform duration-150 hover:scale-110 focus:scale-110 cursor-pointer" />
      <Image src="/Menu.svg" alt="Menu" width={22} height={22} className="md:hidden w-[22px] h-[22px] sm:w-[24px] sm:h-[24px] md:w-[28px] md:h-[28px] lg:w-[32px] lg:h-[32px] transition-transform duration-150 hover:scale-110 focus:scale-110 cursor-pointer" />
    </div>
  </motion.nav>
);
